...
/**
  ...
  *
  * This was found at http://behindcompanies.com/2014/01/a-simple-script-for-deploying-code-with-githubs-webhooks/
  * Credit where it's due!
**/

// Set Variables
$LOCAL_ROOT         = "../";			//<-- THIS MUST BE CHANGED!
$LOCAL_REPO_NAME    = "bc-wp-2015";
$LOCAL_REPO         = "{$LOCAL_ROOT}/{$LOCAL_REPO_NAME}";
$REMOTE_REPO        = "https://github.com/berea/bc-wp-2015.git";
$BRANCH             = "master";
